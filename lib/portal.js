...
class Portal {
  ...
  getSiteIdentity (siteId) {
    ...
    // TODO: Not sure exactly what we want here but i think we are going from remote peerID to networkID
    // maybe just return peerID?
  ...
  broadcastEditorProxyCreation (editorProxy) {
    ...
    // TODO: notify jportals of new editor proxy
    // this.router.notify({channelId: `/portals/${this.id}`, body: updateMessage.serializeBinary()})
  }
