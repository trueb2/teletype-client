...
class EditorProxy {
  ...
  dispose () {
    ...
    // TODO: DecNet notify editor disposal
  ...
  serialize () {
    ...
    // });
    //
    return Messages.EditorProxy.encode(editorProxy).finish();
  }
  ...
  createLocalSelectionsLayer (selections) {
    ...
    // TODO: DecNet notify editor update channel for site
  ...
  receiveFetch ({requestId}) {
    this.router.respond({requestId, body: this.serialize()})
  }
